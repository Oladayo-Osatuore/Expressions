...
var ApplicationConfiguration = function () {
    ...
    var applicationModuleName = 'expressions';
...
// Use applicaion configuration module to register a new module
ApplicationConfiguration.registerModule('lists');'use strict';
// Use Applicaion configuration module to register a new module
...
//Setting up route
angular.module('lists').config([
  '$stateProvider',
  function ($stateProvider) {
    // Lists state routing
    $stateProvider.state('listLists', {
      url: '/lists',
...
// Lists controller
angular.module('lists').controller('ListsController', [
  '$scope',
  '$sce',
  '$stateParams',
  '$location',
  ...
  function ($scope, $sce, $stateParams, $location, Authentication, Lists, Items) {
    ...
    // Find existing List
    $scope.findOne = function () {
      $scope.list = Lists.get({ listId: $stateParams.listId }, function (e) {
        console.log(e);
      });
    };
  }
...
angular.module('lists').factory('Lists', [
  '$resource',
  function ($resource) {
    return $resource('lists/:listId', { listId: '@_id' }, { update: { method: 'PUT' } });
  }
]);
angular.module('lists').factory('Items', [
  '$resource',
  function ($resource) {
    return $resource('/lists/:listId/items/:itemId', {
      listId: '@list',
      itemId: '@_id'
    }, { update: { method: 'PUT' } });
  }
